...
Feature: Validation for Workspace Issues
  ...
  Scenario: This object step definition text parameter exists with other parameters validation
    ...
    Even when the step definition has multiple parameters, the Content parameter should still be found.
  ...
  Scenario: This object exists validation

    No validation warning is shown if the step object file exists in the workspace for the specified component.
  ...
  Scenario: This object step definition exists validation

    No validation warning is shown if the step definition exists in the step object file.
  ...
  Scenario: This object step definition parameter set exists validation

    No validation warning is shown if the header row cells match an existing step parameter set.
